...
public class ClientDB implements java.io.Serializable {
	...
	@JsonSerialize(using = com.dsouthard.util.JSONSerializer.class)
	@JsonDeserialize(using = com.dsouthard.util.JSONDeserialize.class)
	...
	// Method to enter in sample data to verify the database connection is working
